...
class OrderManagerStub(object):
    """Сервис OrderManager — наш набор удалённых процедур
    """
    ...
    def __init__(self, channel):
        ...
        self.GetOrderStatus = channel.unary_unary(
                '/order.OrderManager/GetOrderStatus',
...
def add_OrderManagerServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'order.OrderManager', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('order.OrderManager', rpc_method_handlers)
